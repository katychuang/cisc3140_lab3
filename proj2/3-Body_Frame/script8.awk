# This script prints data on each car with that car's total body frame score and ranking in ascending order of ranking
...
# assign a rank to each row based on the body frame total scores
