# This script prints data on each car with that car's total mods score and ranking in ascending order of ranking
...
# assign a rank to each row based on the mods total scores
